...
// جلب الوظائف + عدد المتقدمين لكل وظيفة
$query = "
SELECT 
    jobs.*,
    COUNT(application.id) AS applicants_count
...
<div class="container my-5">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            ...
            <p class="text-muted">
                Manage your job listings, view applicants, and update details.
            </p>
                    ...
                    <tr>
                        ...
                        <td colspan="6" class="text-center py-5">
                            ...
                            <p class="text-muted mb-2">
                                No jobs found. Click "Add New Job" to post your first job!
                            </p>

                            <a href="add_jobs.php" class="btn btn-primary btn-sm">
                                Add New Job
                            </a>

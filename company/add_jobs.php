...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit_job'])) {
    ...
    if (empty($title) || empty($category_id) || empty($job_type) || empty($location) || empty($description)) {
        ...
        (company_id, title, description, salary, location, job_type, status, category_id) 
        VALUES 
        ('$company_id_db', '$title', '$description', '$salary', '$location', '$job_type', 'open', '$category_id')";
        ...
        <div class="col-lg-9">
            ...
            <div class="card card-job-form p-4 p-md-5 shadow-sm border-0">
                ...
                <div class="mb-4">
                    ...
                    <p class="text-muted">
                        Fill in the details below to publish a job vacancy.
                    </p>
                </div>
                ...
                <form method="POST" action="add_jobs.php">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12 mt-4">
                            ...
                            <button type="submit" name="submit_job" class="btn btn-primary w-100 py-2">
